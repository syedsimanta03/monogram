    ...
    <header className="min-h-screen w-full z-10 relative" ref={myRef}>
      <div className="flex flex-wrap">
        ...
        <div className="pl-12 pt-14 md:pl-32 md:pt-20">
          <h1 id='jamstack' className="font-extrabold text-4xl sm:text-6xl md:text-8xl text-jm-orange whitespace-nowrap slide-up">
            jamstack{" "}
            <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-indigo-500">
              101
            </span>
          </h1>
          <p id='jam-text' className="max-w-1/2 md:w-[500px] mt-4 pr-4 slide-up">
          ...
          <img src="/dotline.svg" alt="dotline" className="-rotate-[60deg] h-[300px] -mt-8 ml-40 hidden xl:block" />
        </div>
        {/* Img graphics */}
